const ShimmerItem = () => {
  return (
    <div className="">
      {" "}
      <div className=" m-4 sm:mb-0 gap-8 sm:w-[500px] md:w-[650px] lg:w-[800px] bg-amber-300 rounded-lg sm:rounded-b-none  animate-pulse">
        <div className="h-56 w-full sm:rounded-l-lg sm:rounded-bl-none sm:rounded-t-lg rounded-l-lg bg-gray-400"></div>
        <div className="pr-10 pt-2 pl-4 w-full mt-10">
      ...
      <div className="flex pt-10 justify-between sm:w-[500px] sm:gap-[215px] gap-[232px] md:w-[650px] lg:w-[800px] bg-amber-300 rounded-lg sm:rounded-b-lg sm:rounded-none mx-4 p-4 mb-4 animate-pulse">
        <div>
        ...
        <div className="flex flex-col items-end m-2">
          <div className="h-30 w-30 bg-gray-400 rounded-lg "></div>
          <div className="h-10 w-24 bg-blue-500 rounded-lg mt-4"></div>
        </div>
      </div>
    </div>
  );
