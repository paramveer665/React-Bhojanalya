const ShimmerItem = () => {
  return (
    <div className="flex justify-center flex-col  ">
      <div className=" m-4 sm:mb-0  sm:w-[500px] md:w-[650px] lg:w-[800px] bg-amber-300 rounded-lg  sm:rounded-b-none flex sm:flex-col animate-pulse border-b-2">
        <div className="h-56 w-2/3 sm:w-full sm:rounded-l-lg sm:rounded-bl-none sm:rounded-t-lg rounded-l-lg bg-gray-400"></div>
